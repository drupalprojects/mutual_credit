...
class WalletController extends ControllerBase {
  ...
  public function page(WalletInterface $wallet) {
    $this->wallet = $wallet;
    echo('In D8 alpha12 waiting for a fix to views.module->views_embed_view. See https://www.drupal.org/node/2208811#comment-8903685');
  ...
  public function pageTitle(WalletInterface $wallet = NULL) {
    if (!$wallet) return 'bug retrieving page title';
