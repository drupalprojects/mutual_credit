...
abstract class OperationBase extends ConfigEntityBase implements OperationInterface {
  ...
  public function settingsForm(array &$form) {
    ...
    $form['op_title'] = array(
      ...
      '#type' => 'textfield',
      '#default_value' => $this->config->get('op_title'),
    ...
    $form['sure']['button']= array(
      ...
      '#type' => 'textfield',
      '#default_value' => $this->config->get('button'),
    ...
    $form['sure']['cancel_button']= array(
      ...
      '#type' => 'textfield',
      '#default_value' => $this->config->get('cancel_button'),
    ...
    $form['feedback']['format2']= array(
      ...
      '#default_value' => $this->config->get('format2'),
      '#required' => TRUE,
      '#weight' => 14
   );
    ...
    $form['notify']['send'] = array(
      ...
      '#type' => 'checkbox',
      '#default_value' => $this->config->get('send'),
      '#weight' =>  0
    );
