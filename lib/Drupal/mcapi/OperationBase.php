...
abstract class OperationBase extends ConfigEntityBase implements OperationInterface {
  ...
  public function settingsForm(array &$form, ConfigFactory $config) {
    ...
    $help = t ( 'Use the following twig tokens: @tokens.', array (
        '@tokens' => $tokens
    ) ) . ' ' . l ( t ( 'What is twig?' ), 'http://twig.sensiolabs.org/doc/templates.html', array (
        'external' => TRUE
    ) );
    ...
    $form ['general'] ['twig'] = array (
        ...
        '#states' => array (
            'visible' => array (
                ':input[name="general[format]"]' => array (
                    'value' => 'twig'
                )
            )
        ),
    ...
    $form ['general'] ['twig2'] = array (
        ...
        '#states' => array (
            'visible' => array (
                ':input[name="general[format2]"]' => array (
                    'value' => 'twig'
                )
            )
        ),
